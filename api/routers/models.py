...
async def get_default_models():
    ...
    try:
        ...
        return DefaultModelsResponse(
            ...
            default_extraction_model=defaults.default_extraction_model,  # type: ignore[attr-defined]
        )
    except Exception as e:
...
async def update_default_models(defaults_data: DefaultModelsResponse):
    ...
    try:
        ...
        if defaults_data.default_extraction_model is not None:
            defaults.default_extraction_model = defaults_data.default_extraction_model  # type: ignore[attr-defined]
