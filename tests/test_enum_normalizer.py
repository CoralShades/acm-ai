...
class TestSampleResultNormalization:
    ...
    def test_presumed_positive(self):
        from open_notebook.extractors.normalizers.enums import normalize_enum_value
        assert normalize_enum_value("presumed positive", "sample_result") == "Assumed Positive"
    ...
    def test_assumed_positive(self):
        from open_notebook.extractors.normalizers.enums import normalize_enum_value
        assert normalize_enum_value("assumed positive", "sample_result") == "Assumed Positive"

    def test_not_sampled(self):
        from open_notebook.extractors.normalizers.enums import normalize_enum_value
        assert normalize_enum_value("not sampled", "sample_result") == "Assumed Positive"
